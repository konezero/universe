...
class SessionObservatoryUiContractTests(unittest.TestCase):
    ...
    def test_mode_cards_show_connected_live_ptys_with_idle_status_without_auto_routing(self) -> None:
        ...
        self.assertIn("No connected sessions in this mode", APP)
        self.assertIn('return [...buckets.working, ...buckets.idle]', APP)
        self.assertIn('const visualState = nodeModeSessionIsWorking(session) ? activityState : "IDLE"', APP)
