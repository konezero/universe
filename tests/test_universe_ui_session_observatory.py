...
class SessionObservatoryUiContractTests(unittest.TestCase):
    ...
    def test_left_rail_renders_nodes_with_fixed_modes_and_session_state(self) -> None:
        ...
        self.assertIn("class UniverseApiError extends Error", APP)
        self.assertIn("[session launch: ${stage}]", APP)
        self.assertIn('sessionLaunchError("CREATE_TERMINAL", error)', APP)
