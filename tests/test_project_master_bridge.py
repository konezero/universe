...
class ProjectMasterBridgeTests(unittest.TestCase):
    ...
    def test_extended_host_runs_instruction_task_frame_at_dedicated_route(self) -> None:
        request = {
        ...
        class CompletedHost(ProjectMasterBridgeHost):
            def run_instruction_authorized_task_frame(
                ...
                owner.assertEqual(request, received)
                return {"status": "INSTRUCTION_TASK_FRAME_COMPLETED"}
        ...
        try:
            http_request = Request(
                endpoint + "/v1/project-master/task-frames/instruction/run",
        ...
        self.assertEqual("INSTRUCTION_TASK_FRAME_COMPLETED", result["status"])
