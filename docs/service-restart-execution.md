...
The installed shared Runtime is `core-93bb0adf2c07-2d3debb5f8d3`
(`career-20260914-094914`), built from career commit
`93bb0adf2c078a7386e09f4cf936e68e300883a3`. career, GCS, design-canvas,
rendezvous and universe are all pinned to this release in LINKED mode.
The managed AGENTS block and project installation surfaces were regenerated by
the canonical installer. Shared store objects retain their immutable hashes.

Installation and update no longer invoke validate/status or require a VERIFIED
result. Applied files yield INSTALLED with validation NOT_RUN. Source hashes,
target containment and collision ownership remain application preconditions;
optional diagnostics are separate from installation completion.
