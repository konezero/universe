...
- [x] Extract pure Bench aggregation into `tools/universe_app/bench_service.py` and preserve the existing UniverseStore/API contract with focused tests.
...
- [x] Maintain changed-module, smoke, API/DB contract, and full regression tiers; focused Bench/server 120 tests + 8 subtests and full 600 tests + 40 subtests passed on 2026-08-11.
