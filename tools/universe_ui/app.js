...
function renderMemory() {
  ...
  Promise.all([
    ...
    if (collection) {
      ...
      FAST_EXTRACT_SOURCE_TOO_LARGE: "활동 기록이 많아 소스 분할 필요", SEMANTIC_SOURCE_NOT_CURRENT: "원문 위치 재확인 필요", SEMANTIC_EVIDENCE_EMPTY: "추출할 본문 없음", SEMANTIC_ACTIVITY_NOT_ATTESTED: "수집 기록 재확인 필요", SOURCE_NOT_FOUND: "원본 소스 없음"};
